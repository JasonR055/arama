...
from Business.util import  makeFakePCAArray, readPhenotypesFromCSVFile, readPhenotypesFromCSVFile_pd
...
class PlotApp2(HasTraits):
    ...
    def __init__(self,PCAData):
        ...
        self.phenotypes, self.pheno_dict = readPhenotypesFromCSVFile_pd('..\IOdata\phenotypes_table_2.csv')
